...
from langchain_community.llms import Ollama  # Assuming you're using Ollama for the LLM
...
def process_pdf(uploaded_file):
    ...
    docs_json = json.dumps([{"page_content": chunk.page_content, "metadata": chunk.metadata} for chunk in chunks])
